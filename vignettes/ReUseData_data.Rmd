...
any available data set either in local cache and on the cloud. If the
data of interest already exist on the cloud, then `getCloudData` will
directly download the data to your computer. Add it to the local
caching system using `dataUpdate()` for later use.
